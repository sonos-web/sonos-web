...
export default {
  ...
  data: () => ({
    tabs: [
      { title: 'Artists', link: '/library/artists' },
      { title: 'Albums', link: '/library/albums' },
      { title: 'Songs', link: '/library/songs' },
      { title: 'Genres', link: '/library/genres' },
      { title: 'Playlists', link: '/library/playlists' },
      { title: 'Shares', link: '/library/share' },
    ],
  }),
};
</script>